...
Version  : 3.1.7
Release  : 12
URL      : https://github.com/mongodb/mongo/archive/r3.1.7.tar.gz
Source0  : https://github.com/mongodb/mongo/archive/r3.1.7.tar.gz
...
License  : AGPL-3.0 Apache-2.0 BSD-3-Clause BSD-3-Clause-Clear BSL-1.0 GPL-2.0 MIT OpenSSL bzip2-1.0.6
...
Patch2: ignore-config-enoent.patch
Patch3: 0001-Change-default-dbpath.patch
Patch4: 0002-Set-default-bind-ip-to-127.0.0.1.patch
...
%install
scons install %{?_smp_mflags} --disable-warnings-as-errors --prefix=%{buildroot}%{_prefix} --ssl --js-engine=mozjs --use-system-pcre --use-system-snappy --use-system-zlib --use-system-yaml
